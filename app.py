...
def chat_with_profile(session_id, user_query, chat_history):
    ...
    """
    if not session_id:
        chat_history.append(gr.ChatMessage(role="user", content=user_query))
        chat_history.append(gr.ChatMessage(role="assistant", content="No profile loaded. Please process a LinkedIn profile first."))
        return chat_history, ""
    
    if session_id not in active_indices:
        chat_history.append(gr.ChatMessage(role="user", content=user_query))
        chat_history.append(gr.ChatMessage(role="assistant", content="Session expired. Please process the LinkedIn profile again."))
        return chat_history, ""
    ...
    try:
        ...
        # Update chat history with ChatMessage format
        chat_history.append(gr.ChatMessage(role="user", content=user_query))
        ...
        chat_history.append(gr.ChatMessage(role="user", content=user_query))
        chat_history.append(gr.ChatMessage(role="assistant", content=f"Error: {str(e)}"))
        return chat_history, ""
